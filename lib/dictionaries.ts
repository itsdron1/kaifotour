...
const ru = {
  ...
  whatsapp: {
    ...
    review: "Здравствуйте! Хочу оставить отзыв о поездке с KAIFO",
  },
  price: {
    from: "от",
