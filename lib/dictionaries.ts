...
const ru = {
  ...
  hero: {
    ...
    stackLabel: "Туры KAIFOTOUR BALI",
    prevTour: "Предыдущий тур",
    nextTour: "Следующий тур",
    stackStatus: "{title}, {n} из {total}",
    openTour: "{title}: подробнее о туре",
  },
  ride: {
...
const en: Dictionary = {
  ...
  hero: {
    ...
    stackLabel: "KAIFOTOUR BALI tours",
    prevTour: "Previous tour",
    nextTour: "Next tour",
    stackStatus: "{title}, {n} of {total}",
    openTour: "{title}: tour details",
  },
  ride: {
