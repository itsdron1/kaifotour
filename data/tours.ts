...
const interestQuoted = (title: string): Localized => ({
  ...
  id: `Hello! I'm interested in the "${title}" tour`,
});
...
const onRequest: Localized = { ru: "По запросу", en: "On request" , id: "On request" };
const oneDay: Localized = { ru: "1 день", en: "1 day" , id: "1 day" };

export const categories: { id: TourCategory; label: Localized }[] = [
  { id: "ocean", label: { ru: "Океан", en: "Ocean" , id: "Ocean" } },
  ...
  { id: "day-tours", label: { ru: "Экскурсии", en: "Day Tours" , id: "Day Tours" } },
  { id: "rides", label: { ru: "Прокат с гидом", en: "Rides" , id: "Rides" } },
];
...
export const tours: Tour[] = [
  {
    ...
    category: "ocean",
    kicker: { ru: "01 / Океан", en: "01 / Ocean" , id: "01 / Ocean" },
    lead: {
      ...
      id: "Sunset and evening cruises on a traditional boat, with dinner on board, live music and a fire show.",
    },
    durationLabel: { ru: "Вечерний круиз", en: "Evening cruise" , id: "Evening cruise" },
    duration: "hours",
    ...
    includes: {
      ...
      id: ["Sunset or evening cruise", "Dinner on board", "Live music", "Fire show"],
    },
    difficulty: "easy",
    badge: null,
  ...
  },
  {
    ...
    title: "Beat Boat",
    category: "ocean",
    kicker: { ru: "02 / Океан", en: "02 / Ocean" , id: "02 / Ocean" },
    lead: {
      ...
      id: "A three-hour cruise with swim stops. On board: a bar, a DJ and a tower for jumping into the sea.",
    },
    durationLabel: { ru: "3 часа", en: "3 hours" , id: "3 hours" },
    duration: "hours",
  ...
  },
  {
    ...
    title: "Fishing",
    category: "ocean",
    kicker: { ru: "03 / Океан", en: "03 / Ocean" , id: "03 / Ocean" },
    lead: {
      ...
      id: "Ocean fishing in two formats, local or professional. Gear and food are included in the price.",
    },
    ...
    includes: {
      ...
      id: ["Local fishing trip", "Professional fishing trip", "Fishing gear", "Food"],
    },
    difficulty: "easy",
    badge: null,
  ...
  },
  {
    ...
    title: "Surfing",
    category: "ocean",
    kicker: { ru: "04 / Океан", en: "04 / Ocean" , id: "04 / Ocean" },
    lead: {
      ...
      id: "Surfing on secret beaches, in small groups and with a guide.",
    },
    durationLabel: onRequest,
    duration: null,
    ...
    includes: {
      ...
      id: ["Spots on secret beaches", "Small groups", "Guide"],
    },
    difficulty: null,
    badge: null,
  ...
  },
  {
    ...
    title: "Snorkeling",
    category: "ocean",
    kicker: { ru: "05 / Океан", en: "05 / Ocean" , id: "05 / Ocean" },
    lead: {
      ...
      id: "Snorkeling at standard spots or a premium trip to see manta rays. The longest option is a full day on Nusa Penida.",
    },
    durationLabel: { ru: "До 9 часов", en: "Up to 9 hours" , id: "Up to 9 hours" },
    duration: null,
    ...
    includes: {
      ...
      id: ["Standard spots", "Premium trip with manta rays", "Full day on Nusa Penida, about 9 hours"],
    },
    difficulty: null,
    badge: null,
    ...
    variants: [
      {
        ...
        lead: {
          ...
          id: "A full day on Nusa Penida: snorkeling with manta rays plus the island's main viewpoints, Kelingking Cliff and Broken Beach.",
        },
        durationLabel: { ru: "1 день, около 9 часов", en: "1 day, about 9 hours" , id: "1 day, about 9 hours" },
        ...
        includes: {
          ...
          id: ["Snorkeling with manta rays", "Kelingking Cliff", "Broken Beach", "Return boat transfer", "Guide"],
        },
  ...
  },
  {
    ...
    lead: {
      ...
      id: "ATV routes from 1 to 4 hours, with new vehicles, a guide and transfer.",
    },
    durationLabel: { ru: "1-4 часа", en: "1-4 hours" , id: "1-4 hours" },
    duration: "hours",
    priceFromIDR: null,
    includes: {
      ru: ["Маршруты от 1 до 4 часов", "Новая техника", "Гид", "Трансфер"],
      en: ["Routes from 1 to 4 hours", "New vehicles", "Guide", "Transfer"],
      id: ["Routes from 1 to 4 hours", "New vehicles", "Guide", "Transfer"],
    },
    difficulty: null,
    badge: null,
  ...
  },
  {
    ...
    lead: {
      ...
      id: "Enduro rides on the Kintamani, Tabanan and Secret Forest routes on Yamaha, Honda and KTM bikes.",
    },
    durationLabel: onRequest,
    duration: null,
    ...
    includes: {
      ...
      id: ["Yamaha, Honda and KTM bikes", "Kintamani route", "Tabanan route", "Secret Forest route"],
    },
    difficulty: null,
    badge: null,
  ...
  },
  {
    ...
    lead: {
      ...
      id: "Jeep tours to sunrises and volcanoes. Routes: Batur and Kintamani, Ubud, Jatiluwih and Bedugul, Munduk.",
    },
    durationLabel: onRequest,
    duration: null,
    ...
    includes: {
      ...
      id: ["Sunrise by the volcano", "Batur / Kintamani route", "Ubud route", "Jatiluwih / Bedugul route", "Munduk route"],
    },
    difficulty: "easy",
    badge: null,
    ...
    variants: [
      {
        ...
        lead: {
          ...
          id: "A jeep safari across the frozen lava fields of Mount Batur: sunrise, breakfast and a swim in natural hot springs. No hiking involved.",
        },
        ...
        includes: {
          ...
          id: ["Sunrise at a viewpoint", "Jeep ride over black lava", "Breakfast or lunch", "Hot springs"],
        },
        note: {
          ...
          id: "Unlike Batur Sunrise Trekking, there is no hike: the whole route is by jeep. A good fit if you are not up for trekking.",
        },
  ...
  },
  {
    ...
    title: "Jet Ski Tours",
    category: "rides",
    kicker: { ru: "01 / Прокат с гидом", en: "01 / Rides" , id: "01 / Rides" },
    lead: {
      ...
      id: "Jet ski rides from 30 minutes to 6 hours. Locations: Sanur, Jimbaran, Nusa Dua and Uluwatu.",
    },
    durationLabel: { ru: "30 мин - 6 ч", en: "30 min - 6 h" , id: "30 min - 6 h" },
    duration: "hours",
    priceFromIDR: null,
    includes: {
      ...
      id: ["Rides from 30 minutes to 6 hours", "Sanur or Jimbaran", "Nusa Dua or Uluwatu"],
    },
    difficulty: null,
    badge: null,
  ...
  },
  {
    ...
    title: "Harley Tours",
    category: "rides",
    kicker: { ru: "02 / Прокат с гидом", en: "02 / Rides" , id: "02 / Rides" },
    lead: {
      ...
      id: "Harley-Davidson tours with five models to choose from, a guide on the route, and photos and video of the ride.",
    },
    durationLabel: onRequest,
    duration: null,
    ...
    includes: {
      ...
      id: ["5 models: Dyna, Sportster, Fat Bob, Heritage, Softail", "Guide", "Photos and video"],
    },
    difficulty: null,
    badge: null,
  ...
  },
  {
    ...
    category: "day-tours",
    kicker: { ru: "01 / Экскурсии", en: "01 / Day Tours" , id: "01 / Day Tours" },
    lead: {
      ...
      id: "A one-day cultural route through the heart of Bali: rice terraces, temples and craft villages. The route is built around your interests, with several combinations of locations to choose from.",
    },
  ...
  },
  {
    ...
    category: "day-tours",
    kicker: { ru: "02 / Экскурсии", en: "02 / Day Tours" , id: "02 / Day Tours" },
    lead: {
      ...
      id: "A hike to the summit of Mount Batur in the dark to watch the sunrise above the clouds, followed by the descent, breakfast and a swim in natural hot springs.",
    },
    durationLabel: { ru: "1 день, ночной старт", en: "1 day, night start" , id: "1 day, night start" },
    duration: "full-day",
    priceFromIDR: 1_300_000,
    includes: {
      ru: [
      ...
      id: ["Trekking guide, flashlights, transfer", "Sunrise ascent", "Breakfast at the summit", "Hot springs swim after the descent"],
    },
    difficulty: "medium",
    difficultyNote: { ru: "пеший подъём около 2 часов", en: "about 2 hours of uphill hiking" , id: "about 2 hours of uphill hiking" },
    badge: null,
  ...
  },
  {
    ...
    category: "day-tours",
    kicker: { ru: "03 / Экскурсии", en: "03 / Day Tours" , id: "03 / Day Tours" },
    lead: {
      ...
      id: "A climb to Bali's highest point at 3,145 metres. For those who want a bigger challenge than Batur: a view over the whole island with sunrise at the summit.",
    },
    durationLabel: { ru: "1,5 дня, ночной выезд", en: "1.5 days, night departure" , id: "1.5 days, night departure" },
    duration: "extended",
    ...
    difficulty: "hard",
    difficultyNote: { ru: "требует физической подготовки", en: "requires good fitness" , id: "requires good fitness" },
    badge: null,
  ...
  },
  {
    ...
    category: "day-tours",
    kicker: { ru: "04 / Экскурсии", en: "04 / Day Tours" , id: "04 / Day Tours" },
    lead: {
      ...
      id: "A journey into Bali's spiritual side: a Melukat purification ceremony at a holy spring and a visit to one of the island's main temples.",
    },
    durationLabel: oneDay,
    duration: "full-day",
    priceFromIDR: 1_600_000,
  ...
  },
  {
    ...
    category: "day-tours",
    kicker: { ru: "05 / Экскурсии", en: "05 / Day Tours" , id: "05 / Day Tours" },
    lead: {
      ...
      id: "The most scenic spots of East Bali in one day: the famous Gates of Heaven, water palaces and a viewpoint facing Mount Agung.",
    },
    durationLabel: oneDay,
    duration: "full-day",
  ...
  },
  {
    ...
    category: "day-tours",
    kicker: { ru: "06 / Экскурсии", en: "06 / Day Tours" , id: "06 / Day Tours" },
    lead: {
      ...
      id: "A one-day route around the southern Bukit Peninsula: a dream beach, a beach club with a glass pool above the ocean, Indonesia's tallest statue and sunset at a clifftop temple.",
    },
    durationLabel: oneDay,
    duration: "full-day",
  ...
  },
  {
    ...
    category: "day-tours",
    kicker: { ru: "07 / Экскурсии", en: "07 / Day Tours" , id: "07 / Day Tours" },
    lead: {
      ...
      id: "A trip to the north of the island: a morning boat ride to wild dolphins in the open sea and a swim at one of Bali's most scenic waterfalls.",
    },
    durationLabel: { ru: "1 день, ранний старт", en: "1 day, early start" , id: "1 day, early start" },
    duration: "full-day",
    priceFromIDR: 1_800_000,
    includes: {
      ...
      id: ["Morning boat trip to see dolphins", "Waterfall visit and swim", "Transfer and guide for the whole day"],
    },
    difficulty: "easy",
    badge: null,
  ...
  },
  {
    ...
    category: "day-tours",
    kicker: { ru: "08 / Экскурсии", en: "08 / Day Tours" , id: "08 / Day Tours" },
    lead: {
      ...
      id: "A two-day route around Nusa Lembongan and Nusa Ceningan: signature spots, snorkeling and kayaking.",
    },
    durationLabel: { ru: "2 дня / 1 ночь", en: "2 days / 1 night" , id: "2 days / 1 night" },
    duration: "extended",
    priceFromIDR: 2_600_000,
    includes: {
      ru: ["Визитные локации островов", "Снорклинг", "Каякинг"],
      en: ["Signature island spots", "Snorkeling", "Kayaking"],
      id: ["Signature island spots", "Snorkeling", "Kayaking"],
    },
    difficulty: null,
    badge: null,
  ...
  },
  {
    ...
    lead: { ru: "", en: "" , id: "" },
    durationLabel: { ru: "3 дня / 2 ночи", en: "3 days / 2 nights" , id: "3 days / 2 nights" },
    duration: "extended",
    priceFromIDR: null,
    includes: { ru: [], en: [] , id: [] },
    difficulty: null,
